...
# make sure uv is on PATH even if this is the shell that just installed it
...
# Download the first ~500M characters of pretraining dataset
...
#inspect failures for question 4
python -m scripts.tok_inspect
# -----------------------------------------------------------------------------
